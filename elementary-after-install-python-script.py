...
regular_packages = ["git", "gedit", "gedit-plugins", "ssh", "gufw", "oracle-java7-installer", "libreoffice", "libxss1", "dconf-tools", "hardinfo", "pavucontrol", "spotify-client", "palimpsest"]
y = "-y"
checker = True
counter = ""
